...
class Listclassname1ItemWidget extends StatelessWidget {
  Listclassname1ItemWidget(this.listclassname1ItemModelObj);

  Listclassname1ItemModel listclassname1ItemModelObj;

  var controller = Get.find<CompletedTasksController>();
